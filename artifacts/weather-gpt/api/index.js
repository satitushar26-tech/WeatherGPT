...
export default async function handler(req, res) {
  ...
  if (path === "/weather/climate") {
    return res.status(200).json(climate);
  }

  if (path === "/weather/chat") {
    if (req.method !== "POST") {
    ...
    if (!message) {
      return res.status(400).json({ error: "Please enter a weather question." });
    }

    const lower = message.toLowerCase();
    const isHindi = /बारिश|कल|तापमान|मौसम/.test(message);
    ...
    if (
      ...
      response = {
        ...
        location: "New Delhi",
        highlights: [
          "78% rain probability tomorrow",
          "14 km/h wind today",
          "Best window: Saturday morning",
        ],
        advisory: {
          title: "Wait to spray",
          status: "Caution",
          ...
          actions: [
            "Check the Saturday forecast",
            "Set a reminder for 7:00 AM",
            "View 5-day forecast",
          ],
        },
      };
      ...
      response = {
        ...
        location: "India",
        highlights: [
          "Flood watch · Dibrugarh",
          "Cyclone advisory · Coastal Odisha",
      ...
      response = {
        ...
        location: "Kerala",
        highlights: [
          "+8.4% rainfall vs baseline",
          "+0.6°C temperature anomaly",
          "July was the wettest month",
        ],
      };
    } else if (isHindi) {
      response = {
        answer:
          "हाँ, कल बारिश की संभावना है। नई दिल्ली में बारिश की संभावना 78% है और लगभग 14 मिमी वर्षा हो सकती है। बाहर जाते समय छाता रखें।",
        intent: "forecast",
