...
const navItems = [
  { href: '/', label: 'Weather desk', icon: Compass },
  { href: '/ask', label: 'Ask WeatherGPT', icon: MessageCircle },
      ...
      <aside className="desktop-sidebar flex flex-col border-r border-[hsl(var(--sidebar-border))] bg-[hsl(var(--sidebar))] text-[hsl(var(--sidebar-foreground))]">
        ...
        <div className="flex items-center gap-3 px-7 pt-8">
          ...
          <div>
            ...
            <div className="mono mt-0.5 text-[9px] uppercase tracking-[.16em] text-[hsl(var(--sidebar-foreground)/.55)]">Weather intelligence · India</div>
          </div>
        </div>
        ...
        <div className="mt-auto px-7 pb-7">
          <div className="rounded-xl border border-[hsl(var(--sidebar-border))] bg-[hsl(var(--sidebar-accent)/.72)] p-4">
            <div className="flex items-center justify-between">
              <span className="mono text-[10px] uppercase tracking-[.14em] text-[hsl(var(--sidebar-foreground)/.6)]">System pulse</span>
            ...
            <p className="mt-3 text-sm leading-snug text-[hsl(var(--sidebar-foreground)/.78)]">
              {health.isError ? 'Data service needs attention.' : 'Public weather signals connected.'}
            </p>
            <div className="mt-3 flex items-center gap-2 text-[11px] text-[hsl(var(--sidebar-foreground)/.55)]">
              <Activity className="h-3.5 w-3.5" /> {health.isLoading ? 'Checking…' : 'Updated moments ago'}
            </div>
          </div>
          <div className="mt-5 flex items-center gap-3">
            ...
            <div className="min-w-0"><p className="truncate text-xs font-semibold">India coverage</p><p className="truncate text-[11px] text-[hsl(var(--sidebar-foreground)/.52)]">Local view · IST</p></div>
          </div>
        </div>
      </aside>
