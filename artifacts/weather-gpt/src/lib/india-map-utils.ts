...
// Sample Weather Stations across India for the live weather monitoring layer
export const PAN_INDIA_WEATHER_STATIONS: WeatherStation[] = [
  {
    id: 'st-delhi',
  ...
  },
  {
    ...
    temperature: 26,
    feelsLike: 29,
    condition: 'Heavy Rain / Flood Watch',
    icon: 'rain',
    humidity: 92,
    windSpeed: 18,
    rainChance: 88,
